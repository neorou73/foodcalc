create table food_description (NDB_No text, FdGrp_Cd text, Long_Desc Shrt_Desc text, ComName text, ManufacName Survey text, Ref_desc text, Refuse SciName text, N_Factor Pro_Factor text, Fat_Factor text, CHO_Factor text);
